  ...
  <div>
        ...
        <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
          <div class="container-fluid">
            <!-- Brand -->
            <a href="/"><img src="https://www.freelogoservices.com/api/main/images/1j+ojFVDOMkX9Wytexe43D6kif+JqxFGkBjIwXs1M3EMoAJtliEuj...Vo9P89"
          style="position: absolute; width: 150px; top: 18px; left: 10px"
        /></a>
            <!-- Form -->
    ...
    <div class="footer">
      <h6>
        <span>Disclaimer</span><span class="footer-dot"> . </span
        ><span>Terms of Service</span><span class="footer-dot"> . </span
        ><span>Privacy Policy</span>
      </h6>
      <h6>
        <!-- <span>@</span> -->
        <span>2021 Sam Collins<span class="footer-dot"> . </span></span
